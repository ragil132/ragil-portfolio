const projects = [
  ...
  },
  {
    ...
    description:
      "Built with Hapi Js, PostgreSQL, Redis, RabbitMQ. A RESTful API which you can do some CRUD operations on music stuff, like adding a song, look some playlists, etc. I built this after i've learnt it from Dicoding",
    image: "./backend_proj.gif",
    link: "https://github.com/ragil132/Ragillio-OpenMusic-API",
  },
  {
    title: "Internal E-meterai Application",
    subtitle: "React, Golang, Docker",
    description:
      "An internal application used in Panin Dubai Syariah Bank for stamping a document with e-meterai supplied by Peruri.",
    image: "./emeterai.png",
    link: "",
  },
  {
