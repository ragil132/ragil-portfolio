...
export default function Projects() {
    return (
        <section id="projects" className="dark:text-gray-400 dark:bg-gray-900 body-font">
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                <div className="flex flex-col w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                        I built this after what i've learnt from various
                        online course (like <a href="https://www.dicoding.com">Dicoding</a>)
                        and college definitely (not much)
                    </p>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">More at my <a href="https://github.com/ragil132">Github</a></p>
                </div>
                    ...
                    {projects.map((project) => (
                        <a
                            ...
                            <div className="md:flex md:relative grid grid-cols-1">
                                <img
                                    alt="gallery"
                                    className="md:absolute md:inset-0 w-full md:h-full lg:h-full md:object-cover md:object-center border-2 border-gray dark:border-black rounded"
                                    src={project.image}
                                />
