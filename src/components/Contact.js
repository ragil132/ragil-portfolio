...
export default function Contact() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    const recipient = "lioajiragil@gmail.com";
    ...
    <>
      <section id="contact" className="relative">
        ...
        <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 mt-8 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            <iframe
              width="100%"
              height="100%"
              title="map"
      ...
      <footer className="text-center bg-gray-200 dark:bg-gray-800 dark:text-white rounded">
        <div className="text-center bg-gray-200 dark:bg-gray-800 p-4">
          ...
          <a
            href="https://twitter.com/aji_ragillio"
            type="button"
            className="rounded-full border-2 border-gray-500 dark:border-white dark:text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
              aria-hidden="true"
              focusable="false"
          ...
          <a
            href="https://www.instagram.com/ragiilll11"
            type="button"
            className="rounded-full border-2 border-gray-500 dark:border-white dark:text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
          ...
          <a
            href="mailto:lioajiragil@gmail.com"
            type="button"
            className="rounded-full border-2 border-gray-500 dark:border-white dark:text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
          ...
          <p className="dark:text-white">
            Made with &#10084; by Ragillio Aji &copy; {new Date().getFullYear()}
          </p>
        </div>
      </footer>
    </>
